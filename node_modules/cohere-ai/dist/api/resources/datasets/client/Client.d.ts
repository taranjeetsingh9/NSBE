...
export declare class Datasets {
     ...
     */
    create(request: Cohere.DatasetsCreateRequest, data: File | fs.ReadStream, evalData?: File | fs.ReadStream, requestOptions?: Datasets.RequestOptions): Promise<Cohere.DatasetsCreateResponse>;
    /**
